...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/ConstellaDevs/Constella";
    const std::string URL_WEBSITE = "<https://constellacoin.cl>";
