...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s constella-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  constella-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded constella transaction") + "\n" +
              "  constella-tx [options] -create [commands]   " + _("Create hex-encoded constella transaction") + "\n" +
              "\n";
